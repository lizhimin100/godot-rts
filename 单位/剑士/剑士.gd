...
@export var 攻击力: float = 25.0
@export var 攻击范围: float = 45.0

const 玩家纹理 := preload("res://小剑资源/兵种/Knights/Troops/Warrior/Blue/Warrior_Blue.png")
const 敌人纹理 := preload("res://小剑资源/兵种/Knights/Troops/Warrior/Red/Warrior_Red.png")
